...
;// CONCATENATED MODULE: ./controllers/usersController.js
...
async function postUsers(req, res) {
    ...
    try {
        ...
        const user = await model_user/* default.findById */.Z.findById(id);
        if (!user) {
...
var __webpack_exports__ = (__webpack_exec__(8149));
